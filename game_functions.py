...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship,
    ...
    # Check for any bullets that have hit aliens; delete bullet and alien.
...
def start_new_level(ai_settings, stats, sb, bullets):
    """Reset screen and move to next level."""
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Check if fleet is at an edge, update all alien positions in fleet"""
...
def save_high_score(stats):
    ...
    with open(stats.ai_settings.filename, 'w') as file_object:
